...
WM_WEAK void TIM0_IRQHandler(void)
{
    timer_irq_callback((void *)TLS_TIMER_ID_0);
}
WM_WEAK void TIM1_IRQHandler(void)
{
   timer_irq_callback((void *)TLS_TIMER_ID_1);
}
WM_WEAK void TIM2_IRQHandler(void)
{
   timer_irq_callback((void *)TLS_TIMER_ID_2);
}
WM_WEAK void TIM3_IRQHandler(void)
{
   timer_irq_callback((void *)TLS_TIMER_ID_3);
}
WM_WEAK void TIM4_IRQHandler(void)
{
   timer_irq_callback((void *)TLS_TIMER_ID_4);
}
WM_WEAK void TIM5_IRQHandler(void)
{
